...
if __name__== '__main__':
    ...
    if run_type == ['TuRBO-1']:
        ...
        df_theta_TuRBO1.to_csv('df_theta_LatTuRBO1_IWTDN2_SWATFT1.csv', sep=',', index = False, encoding='utf-8')
        
        df_output_TuRBO1 =  pd.DataFrame(fX)
        df_output_TuRBO1.to_csv('df_output_LatTuRBO1_IWTDN2_SWATFT1.csv', sep=',', index = False, encoding='utf-8')
